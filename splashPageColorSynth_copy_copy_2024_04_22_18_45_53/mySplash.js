...
fill(255, 180, 193);
  ...
  this.info = createDiv("<p> This is a monophonic, equal temperament synthesizer that changes pitch based on the dominant color shown in the video screen. You can manipulate this by adding or subtracting different colors from your web camera. Click anywhere to begin the display! <p> ");
